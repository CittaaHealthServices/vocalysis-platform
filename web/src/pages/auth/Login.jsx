    ...
    <div className="min-h-screen flex overflow-hidden" style={{ background: '#0f0a1e' }}>
      ...
      <div className="hidden lg:flex lg:w-[55%] relative flex-col justify-between p-12 overflow-hidden"
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}
          ...
          <div>
            <span className="text-white font-bold text-xl tracking-tight">Vocalysis</span>
            <span className="ml-2 text-xs text-white/50 font-medium">Platform 2.0</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="rounded-2xl border border-white/10 p-8 lg:p-10"
            ...
            <div className="flex lg:hidden items-center gap-3 mb-8">
              ...
              <span className="text-white font-bold text-lg">Vocalysis <span className="text-white/40 font-normal text-sm">Platform 2.0</span></span>
            </div>
